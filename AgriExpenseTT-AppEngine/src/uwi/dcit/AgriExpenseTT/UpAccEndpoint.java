...
import uwi.dcit.AgriExpenseTT.EMF;

@Api(name = "upaccendpoint", namespace = @ApiNamespace(ownerDomain = "dcit.uwi", ownerName = "dcit.uwi", packagePath="agriexpensett"))
public class UpAccEndpoint {
  ...
  public UpAcc updateUpAcc(UpAcc upacc) {
    EntityManager mgr = getEntityManager();
    try {
      if(!containsUpAcc(upacc)) {

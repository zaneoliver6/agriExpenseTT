...
package uwi.dcit.agriexpensett.translogendpoint;
...
public class Translogendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetAllTranslog extends TranslogendpointRequest<TransLogCollection> {
    ...
    protected GetAllTranslog(java.lang.String namespace) {
      super(Translogendpoint.this, "GET", REST_PATH, null, TransLogCollection.class);
      this.namespace = com.google.api.client.util.Preconditions.checkNotNull(namespace, "Required parameter namespace must be specified.");
    }
  ...
  public class GetTransLog extends TranslogendpointRequest<TransLog> {
    ...
    protected GetTransLog(java.lang.Long id) {
      super(Translogendpoint.this, "GET", REST_PATH, null, TransLog.class);
   ...
   * operation.
   *
   * @param content the {@link uwi.dcit.agriexpensett.translogendpoint.model.TransLog}
   * @return the request
   */
  public InsertTransLog insertTransLog(TransLog content) throws java.io.IOException {
    InsertTransLog result = new InsertTransLog(content);
    initialize(result);
    return result;
  }

  public class InsertTransLog extends TranslogendpointRequest<TransLog> {
     ...
     * @since 1.13
     */
    protected InsertTransLog(TransLog content) {
      super(Translogendpoint.this, "POST", REST_PATH, content, TransLog.class);
    }
  ...
  public class ListTransLog extends TranslogendpointRequest<CollectionResponseTransLog> {
    ...
    protected ListTransLog() {
      super(Translogendpoint.this, "GET", REST_PATH, null, CollectionResponseTransLog.class);
    }
  ...
  public class Logs extends TranslogendpointRequest<TransLogCollection> {
    ...
    protected Logs(java.lang.Long time, java.lang.String namespace) {
      super(Translogendpoint.this, "POST", REST_PATH, null, TransLogCollection.class);
   ...
   * @return the request
   */
  public UpdateTransLog updateTransLog(TransLog content) throws java.io.IOException {
    UpdateTransLog result = new UpdateTransLog(content);
    initialize(result);
    return result;
  }

  public class UpdateTransLog extends TranslogendpointRequest<TransLog> {
     ...
     * @since 1.13
     */
    protected UpdateTransLog(TransLog content) {
      super(Translogendpoint.this, "PUT", REST_PATH, content, TransLog.class);
    }

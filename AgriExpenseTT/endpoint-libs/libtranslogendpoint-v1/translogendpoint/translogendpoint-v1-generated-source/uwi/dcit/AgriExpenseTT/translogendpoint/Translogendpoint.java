...
public class Translogendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetTransLog extends TranslogendpointRequest<uwi.dcit.agriexpensett.translogendpoint.model.TransLog> {
    ...
    protected GetTransLog(java.lang.Long id) {
      super(Translogendpoint.this, "GET", REST_PATH, null, uwi.dcit.agriexpensett.translogendpoint.model.TransLog.class);
   ...
   * @return the request
   */
  public InsertTransLog insertTransLog(uwi.dcit.agriexpensett.translogendpoint.model.TransLog content) throws java.io.IOException {
    InsertTransLog result = new InsertTransLog(content);
    initialize(result);
    return result;
  }

  public class InsertTransLog extends TranslogendpointRequest<uwi.dcit.agriexpensett.translogendpoint.model.TransLog> {
     ...
     * @since 1.13
     */
    protected InsertTransLog(uwi.dcit.agriexpensett.translogendpoint.model.TransLog content) {
      super(Translogendpoint.this, "POST", REST_PATH, content, uwi.dcit.agriexpensett.translogendpoint.model.TransLog.class);
    }
  ...
  public class ListTransLog extends TranslogendpointRequest<uwi.dcit.agriexpensett.translogendpoint.model.CollectionResponseTransLog> {
    ...
    protected ListTransLog() {
      super(Translogendpoint.this, "GET", REST_PATH, null, uwi.dcit.agriexpensett.translogendpoint.model.CollectionResponseTransLog.class);
    }
  ...
  public class Logs extends TranslogendpointRequest<uwi.dcit.agriexpensett.translogendpoint.model.TransLogCollection> {
    ...
    protected Logs(java.lang.Long time) {
      super(Translogendpoint.this, "POST", REST_PATH, null, uwi.dcit.agriexpensett.translogendpoint.model.TransLogCollection.class);
   ...
   * @return the request
   */
  public UpdateTransLog updateTransLog(uwi.dcit.agriexpensett.translogendpoint.model.TransLog content) throws java.io.IOException {
    UpdateTransLog result = new UpdateTransLog(content);
    initialize(result);
    return result;
  }

  public class UpdateTransLog extends TranslogendpointRequest<uwi.dcit.agriexpensett.translogendpoint.model.TransLog> {
     ...
     * @since 1.13
     */
    protected UpdateTransLog(uwi.dcit.agriexpensett.translogendpoint.model.TransLog content) {
      super(Translogendpoint.this, "PUT", REST_PATH, content, uwi.dcit.agriexpensett.translogendpoint.model.TransLog.class);
    }

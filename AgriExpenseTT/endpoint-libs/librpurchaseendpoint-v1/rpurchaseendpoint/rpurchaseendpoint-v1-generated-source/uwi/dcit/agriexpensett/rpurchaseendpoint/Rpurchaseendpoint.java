 ...
 * on 2014-12-29 at 15:46:53 UTC 
 * Modify at your own risk.
 */

package uwi.dcit.agriexpensett.rpurchaseendpoint;
...
public class Rpurchaseendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "fetchAllPurchases".
   *
   * This request holds the parameters needed by the rpurchaseendpoint server.  After setting any
   * optional parameters, call the {@link FetchAllPurchases#execute()} method to invoke the remote
   * operation.
   *
   * @return the request
   */
  public FetchAllPurchases fetchAllPurchases() throws java.io.IOException {
    FetchAllPurchases result = new FetchAllPurchases();
    initialize(result);
    return result;
  }

  public class FetchAllPurchases extends RpurchaseendpointRequest<RPurchaseCollection> {

    private static final String REST_PATH = "fetchAllPurchases";

    /**
     * Create a request for the method "fetchAllPurchases".
     *
     * This request holds the parameters needed by the the rpurchaseendpoint server.  After setting
     * any optional parameters, call the {@link FetchAllPurchases#execute()} method to invoke the
     * remote operation. <p> {@link FetchAllPurchases#initialize(com.google.api.client.googleapis.serv
     * ices.AbstractGoogleClientRequest)} must be called to initialize this instance immediately after
     * invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected FetchAllPurchases() {
      super(Rpurchaseendpoint.this, "POST", REST_PATH, null, RPurchaseCollection.class);
    }

    @Override
    public FetchAllPurchases setAlt(java.lang.String alt) {
      return (FetchAllPurchases) super.setAlt(alt);
    }

    @Override
    public FetchAllPurchases setFields(java.lang.String fields) {
      return (FetchAllPurchases) super.setFields(fields);
    }

    @Override
    public FetchAllPurchases setKey(java.lang.String key) {
      return (FetchAllPurchases) super.setKey(key);
    }

    @Override
    public FetchAllPurchases setOauthToken(java.lang.String oauthToken) {
      return (FetchAllPurchases) super.setOauthToken(oauthToken);
    }

    @Override
    public FetchAllPurchases setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (FetchAllPurchases) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public FetchAllPurchases setQuotaUser(java.lang.String quotaUser) {
      return (FetchAllPurchases) super.setQuotaUser(quotaUser);
    }

    @Override
    public FetchAllPurchases setUserIp(java.lang.String userIp) {
      return (FetchAllPurchases) super.setUserIp(userIp);
    }

    @Override
    public FetchAllPurchases set(String parameterName, Object value) {
      return (FetchAllPurchases) super.set(parameterName, value);
    }
  }
  ...
  public class GetAllPurchases extends RpurchaseendpointRequest<RPurchaseCollection> {
    ...
    protected GetAllPurchases(java.lang.String namespace) {
      super(Rpurchaseendpoint.this, "GET", REST_PATH, null, RPurchaseCollection.class);
      this.namespace = com.google.api.client.util.Preconditions.checkNotNull(namespace, "Required parameter namespace must be specified.");
    }
  ...
  public class GetRPurchase extends RpurchaseendpointRequest<RPurchase> {
    ...
    protected GetRPurchase(java.lang.String namespace, java.lang.String keyrep) {
      super(Rpurchaseendpoint.this, "GET", REST_PATH, null, RPurchase.class);
      this.namespace = com.google.api.client.util.Preconditions.checkNotNull(namespace, "Required parameter namespace must be specified.");
      this.keyrep = com.google.api.client.util.Preconditions.checkNotNull(keyrep, "Required parameter keyrep must be specified.");
    }
   ...
   * operation.
   *
   * @param content the {@link uwi.dcit.agriexpensett.rpurchaseendpoint.model.RPurchase}
   * @return the request
   */
  public InsertRPurchase insertRPurchase(RPurchase content) throws java.io.IOException {
    InsertRPurchase result = new InsertRPurchase(content);
    initialize(result);
    return result;
  }

  public class InsertRPurchase extends RpurchaseendpointRequest<RPurchase> {
     ...
     * @since 1.13
     */
    protected InsertRPurchase(RPurchase content) {
      super(Rpurchaseendpoint.this, "POST", REST_PATH, content, RPurchase.class);
    }
  ...
  public class ListRPurchase extends RpurchaseendpointRequest<CollectionResponseRPurchase> {
    ...
    protected ListRPurchase() {
      super(Rpurchaseendpoint.this, "GET", REST_PATH, null, CollectionResponseRPurchase.class);
    }
   ...
   * @return the request
   */
  public UpdateRPurchase updateRPurchase(RPurchase content) throws java.io.IOException {
    UpdateRPurchase result = new UpdateRPurchase(content);
    initialize(result);
    return result;
  }

  public class UpdateRPurchase extends RpurchaseendpointRequest<RPurchase> {
     ...
     * @since 1.13
     */
    protected UpdateRPurchase(RPurchase content) {
      super(Rpurchaseendpoint.this, "PUT", REST_PATH, content, RPurchase.class);
    }

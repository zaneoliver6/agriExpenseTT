...
public class Rpurchaseendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetRPurchase extends RpurchaseendpointRequest<uwi.dcit.AgriExpenseTT.rpurchaseendpoint.model.RPurchase> {
    ...
    protected GetRPurchase(java.lang.String id) {
      super(Rpurchaseendpoint.this, "GET", REST_PATH, null, uwi.dcit.AgriExpenseTT.rpurchaseendpoint.model.RPurchase.class);
   ...
   * @return the request
   */
  public InsertRPurchase insertRPurchase(uwi.dcit.AgriExpenseTT.rpurchaseendpoint.model.RPurchase content) throws java.io.IOException {
    InsertRPurchase result = new InsertRPurchase(content);
    initialize(result);
    return result;
  }

  public class InsertRPurchase extends RpurchaseendpointRequest<uwi.dcit.AgriExpenseTT.rpurchaseendpoint.model.RPurchase> {
     ...
     * @since 1.13
     */
    protected InsertRPurchase(uwi.dcit.AgriExpenseTT.rpurchaseendpoint.model.RPurchase content) {
      super(Rpurchaseendpoint.this, "POST", REST_PATH, content, uwi.dcit.AgriExpenseTT.rpurchaseendpoint.model.RPurchase.class);
    }
  ...
  public class ListRPurchase extends RpurchaseendpointRequest<uwi.dcit.AgriExpenseTT.rpurchaseendpoint.model.CollectionResponseRPurchase> {
    ...
    protected ListRPurchase() {
      super(Rpurchaseendpoint.this, "GET", REST_PATH, null, uwi.dcit.AgriExpenseTT.rpurchaseendpoint.model.CollectionResponseRPurchase.class);
    }
   ...
   * @return the request
   */
  public UpdateRPurchase updateRPurchase(uwi.dcit.AgriExpenseTT.rpurchaseendpoint.model.RPurchase content) throws java.io.IOException {
    UpdateRPurchase result = new UpdateRPurchase(content);
    initialize(result);
    return result;
  }

  public class UpdateRPurchase extends RpurchaseendpointRequest<uwi.dcit.AgriExpenseTT.rpurchaseendpoint.model.RPurchase> {
     ...
     * @since 1.13
     */
    protected UpdateRPurchase(uwi.dcit.AgriExpenseTT.rpurchaseendpoint.model.RPurchase content) {
      super(Rpurchaseendpoint.this, "PUT", REST_PATH, content, uwi.dcit.AgriExpenseTT.rpurchaseendpoint.model.RPurchase.class);
    }

...
package uwi.dcit.agriexpensett.upaccendpoint;
...
public class Upaccendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.18.0-rc of the upaccendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   *
   * This request holds the parameters needed by the upaccendpoint server.  After setting any optional
   * parameters, call the {@link GetUpAcc#execute()} method to invoke the remote operation.
   *
   * @param id
   * @return the request
   */
  public GetUpAcc getUpAcc(java.lang.Long id) throws java.io.IOException {
    GetUpAcc result = new GetUpAcc(id);
    initialize(result);
    return result;
  }

  public class GetUpAcc extends UpaccendpointRequest<uwi.dcit.agriexpensett.upaccendpoint.model.UpAcc> {
     ...
     * @since 1.13
     */
    protected GetUpAcc(java.lang.Long id) {
      super(Upaccendpoint.this, "GET", REST_PATH, null, uwi.dcit.agriexpensett.upaccendpoint.model.UpAcc.class);
   ...
   *
   * This request holds the parameters needed by the upaccendpoint server.  After setting any optional
   * parameters, call the {@link InsertUpAcc#execute()} method to invoke the remote operation.
   *
   * @param content the {@link uwi.dcit.agriexpensett.upaccendpoint.model.UpAcc}
   * @return the request
   */
  public InsertUpAcc insertUpAcc(uwi.dcit.agriexpensett.upaccendpoint.model.UpAcc content) throws java.io.IOException {
    InsertUpAcc result = new InsertUpAcc(content);
    initialize(result);
    return result;
  }

  public class InsertUpAcc extends UpaccendpointRequest<uwi.dcit.agriexpensett.upaccendpoint.model.UpAcc> {
     ...
     * @since 1.13
     */
    protected InsertUpAcc(uwi.dcit.agriexpensett.upaccendpoint.model.UpAcc content) {
      super(Upaccendpoint.this, "POST", REST_PATH, content, uwi.dcit.agriexpensett.upaccendpoint.model.UpAcc.class);
    }
   ...
   *
   * This request holds the parameters needed by the upaccendpoint server.  After setting any optional
   * parameters, call the {@link ListUpAcc#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  ...
  public class ListUpAcc extends UpaccendpointRequest<uwi.dcit.agriexpensett.upaccendpoint.model.CollectionResponseUpAcc> {
     ...
     */
    protected ListUpAcc() {
      super(Upaccendpoint.this, "GET", REST_PATH, null, uwi.dcit.agriexpensett.upaccendpoint.model.CollectionResponseUpAcc.class);
    }
   ...
   *
   * This request holds the parameters needed by the upaccendpoint server.  After setting any optional
   * parameters, call the {@link RemoveUpAcc#execute()} method to invoke the remote operation.
   *
   * @param id
   * @return the request
   */
   ...
   *
   * This request holds the parameters needed by the upaccendpoint server.  After setting any optional
   * parameters, call the {@link UpdateUpAcc#execute()} method to invoke the remote operation.
   *
   * @param content the {@link uwi.dcit.agriexpensett.upaccendpoint.model.UpAcc}
   * @return the request
   */
  public UpdateUpAcc updateUpAcc(uwi.dcit.agriexpensett.upaccendpoint.model.UpAcc content) throws java.io.IOException {
    UpdateUpAcc result = new UpdateUpAcc(content);
    initialize(result);
    return result;
  }

  public class UpdateUpAcc extends UpaccendpointRequest<uwi.dcit.agriexpensett.upaccendpoint.model.UpAcc> {
     ...
     * @since 1.13
     */
    protected UpdateUpAcc(uwi.dcit.agriexpensett.upaccendpoint.model.UpAcc content) {
      super(Upaccendpoint.this, "PUT", REST_PATH, content, uwi.dcit.agriexpensett.upaccendpoint.model.UpAcc.class);
    }

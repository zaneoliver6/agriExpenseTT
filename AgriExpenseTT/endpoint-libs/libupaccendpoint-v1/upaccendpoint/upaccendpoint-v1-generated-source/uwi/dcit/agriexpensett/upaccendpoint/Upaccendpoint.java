 ...
 * on 2014-12-29 at 15:46:44 UTC 
 * Modify at your own risk.
 */

package uwi.dcit.agriexpensett.upaccendpoint;

import uwi.dcit.agriexpensett.upaccendpoint.model.CollectionResponseUpAcc;
...
public class Upaccendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetUpAcc getUpAcc(java.lang.Long id, java.lang.String namespace) throws java.io.IOException {
    GetUpAcc result = new GetUpAcc(id, namespace);
    initialize(result);
    return result;
  }

  public class GetUpAcc extends UpaccendpointRequest<UpAcc> {

    private static final String REST_PATH = "upacc/{id}/{namespace}";
     ...
     * @since 1.13
     */
    protected GetUpAcc(java.lang.Long id, java.lang.String namespace) {
      super(Upaccendpoint.this, "GET", REST_PATH, null, UpAcc.class);
    ...
    public GetUpAcc setNamespace(java.lang.String namespace) {
   ...
   * @return the request
   */
  public InsertUpAcc insertUpAcc(UpAcc content) throws java.io.IOException {
    InsertUpAcc result = new InsertUpAcc(content);
    initialize(result);
    return result;
  }

  public class InsertUpAcc extends UpaccendpointRequest<UpAcc> {
     ...
     * @since 1.13
     */
    protected InsertUpAcc(UpAcc content) {
      super(Upaccendpoint.this, "POST", REST_PATH, content, UpAcc.class);
    }
  ...
  public class ListUpAcc extends UpaccendpointRequest<CollectionResponseUpAcc> {
     ...
     */
    protected ListUpAcc() {
      super(Upaccendpoint.this, "GET", REST_PATH, null, CollectionResponseUpAcc.class);
    }
   ...
   * @return the request
   */
  public UpdateUpAcc updateUpAcc(UpAcc content) throws java.io.IOException {
  ...
  public class UpdateUpAcc extends UpaccendpointRequest<Void> {
     ...
     * @since 1.13
     */
    protected UpdateUpAcc(UpAcc content) {

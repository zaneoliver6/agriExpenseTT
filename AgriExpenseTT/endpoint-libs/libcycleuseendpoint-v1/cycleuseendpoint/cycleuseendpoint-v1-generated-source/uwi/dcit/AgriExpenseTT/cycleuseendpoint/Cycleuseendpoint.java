 ...
 * on 2014-07-14 at 03:13:43 UTC 
 * Modify at your own risk.
 */

package uwi.dcit.agriexpensett.cycleuseendpoint;
...
public class Cycleuseendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetCycleUse getCycleUse(java.lang.String id) throws java.io.IOException {
    GetCycleUse result = new GetCycleUse(id);
    initialize(result);
    return result;
  }

  public class GetCycleUse extends CycleuseendpointRequest<uwi.dcit.agriexpensett.cycleuseendpoint.model.CycleUse> {

    private static final String REST_PATH = "cycleuse/{id}";
     ...
     * @since 1.13
     */
    protected GetCycleUse(java.lang.String id) {
      super(Cycleuseendpoint.this, "GET", REST_PATH, null, uwi.dcit.agriexpensett.cycleuseendpoint.model.CycleUse.class);
    ...
    public GetCycleUse setId(java.lang.String id) {
      this.id = id;
      return this;
    }
   ...
   * operation.
   *
   * @param content the {@link uwi.dcit.agriexpensett.cycleuseendpoint.model.CycleUse}
   * @return the request
   */
  public InsertCycleUse insertCycleUse(uwi.dcit.agriexpensett.cycleuseendpoint.model.CycleUse content) throws java.io.IOException {
    InsertCycleUse result = new InsertCycleUse(content);
    initialize(result);
    return result;
  }

  public class InsertCycleUse extends CycleuseendpointRequest<uwi.dcit.agriexpensett.cycleuseendpoint.model.CycleUse> {
     ...
     * @since 1.13
     */
    protected InsertCycleUse(uwi.dcit.agriexpensett.cycleuseendpoint.model.CycleUse content) {
      super(Cycleuseendpoint.this, "POST", REST_PATH, content, uwi.dcit.agriexpensett.cycleuseendpoint.model.CycleUse.class);
    }
  ...
  public class ListCycleUse extends CycleuseendpointRequest<uwi.dcit.agriexpensett.cycleuseendpoint.model.CollectionResponseCycleUse> {
    ...
    protected ListCycleUse() {
      super(Cycleuseendpoint.this, "GET", REST_PATH, null, uwi.dcit.agriexpensett.cycleuseendpoint.model.CollectionResponseCycleUse.class);
    }
   ...
   * @return the request
   */
  public RemoveCycleUse removeCycleUse(java.lang.String id) throws java.io.IOException {
    RemoveCycleUse result = new RemoveCycleUse(id);
    initialize(result);
    return result;
  }
  ...
  public class RemoveCycleUse extends CycleuseendpointRequest<Void> {
     ...
     * @since 1.13
     */
    protected RemoveCycleUse(java.lang.String id) {
    ...
    public RemoveCycleUse setId(java.lang.String id) {
      this.id = id;
      return this;
    }
   ...
   * @return the request
   */
  public UpdateCycleUse updateCycleUse(uwi.dcit.agriexpensett.cycleuseendpoint.model.CycleUse content) throws java.io.IOException {
    UpdateCycleUse result = new UpdateCycleUse(content);
    initialize(result);
    return result;
  }

  public class UpdateCycleUse extends CycleuseendpointRequest<uwi.dcit.agriexpensett.cycleuseendpoint.model.CycleUse> {
     ...
     * @since 1.13
     */
    protected UpdateCycleUse(uwi.dcit.agriexpensett.cycleuseendpoint.model.CycleUse content) {
      super(Cycleuseendpoint.this, "PUT", REST_PATH, content, uwi.dcit.agriexpensett.cycleuseendpoint.model.CycleUse.class);
    }

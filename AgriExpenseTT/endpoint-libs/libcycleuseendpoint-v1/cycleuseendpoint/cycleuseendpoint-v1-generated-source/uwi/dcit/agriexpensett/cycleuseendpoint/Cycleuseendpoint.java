...
public class Cycleuseendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetAllCycleUse extends CycleuseendpointRequest<CycleUseCollection> {
    ...
    protected GetAllCycleUse(java.lang.String namespace) {
      super(Cycleuseendpoint.this, "GET", REST_PATH, null, CycleUseCollection.class);
      this.namespace = com.google.api.client.util.Preconditions.checkNotNull(namespace, "Required parameter namespace must be specified.");
    }
  ...
  public class GetCycleUse extends CycleuseendpointRequest<CycleUse> {
    ...
    protected GetCycleUse(java.lang.String namespace, java.lang.String keyrep) {
      super(Cycleuseendpoint.this, "GET", REST_PATH, null, CycleUse.class);
      this.namespace = com.google.api.client.util.Preconditions.checkNotNull(namespace, "Required parameter namespace must be specified.");
   ...
   * @return the request
   */
  public InsertCycleUse insertCycleUse(CycleUse content) throws java.io.IOException {
    InsertCycleUse result = new InsertCycleUse(content);
    initialize(result);
    return result;
  }

  public class InsertCycleUse extends CycleuseendpointRequest<CycleUse> {
     ...
     * @since 1.13
     */
    protected InsertCycleUse(CycleUse content) {
      super(Cycleuseendpoint.this, "POST", REST_PATH, content, CycleUse.class);
    }
  ...
  public class ListCycleUse extends CycleuseendpointRequest<CollectionResponseCycleUse> {
    ...
    protected ListCycleUse() {
      super(Cycleuseendpoint.this, "GET", REST_PATH, null, CollectionResponseCycleUse.class);
    }
   ...
   * @return the request
   */
  public UpdateCycleUse updateCycleUse(CycleUse content) throws java.io.IOException {
    UpdateCycleUse result = new UpdateCycleUse(content);
    initialize(result);
    return result;
  }

  public class UpdateCycleUse extends CycleuseendpointRequest<CycleUse> {
     ...
     * @since 1.13
     */
    protected UpdateCycleUse(CycleUse content) {
      super(Cycleuseendpoint.this, "PUT", REST_PATH, content, CycleUse.class);
    }

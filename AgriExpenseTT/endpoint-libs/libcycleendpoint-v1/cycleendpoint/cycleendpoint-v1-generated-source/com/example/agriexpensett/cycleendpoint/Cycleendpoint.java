...
public class Cycleendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetMatchingCycles getMatchingCycles(java.lang.String cropName, java.lang.Double landQty) throws java.io.IOException {
    GetMatchingCycles result = new GetMatchingCycles(cropName, landQty);
    initialize(result);
    return result;
  }
  ...
  public class GetMatchingCycles extends CycleendpointRequest<com.example.agriexpensett.cycleendpoint.model.CollectionResponseCycle> {
    ...
    private static final String REST_PATH = "collectionresponse_cycle/{cropName}/{landQty}";
     ...
     * @since 1.13
     */
    protected GetMatchingCycles(java.lang.String cropName, java.lang.Double landQty) {
      ...
      this.landQty = com.google.api.client.util.Preconditions.checkNotNull(landQty, "Required parameter landQty must be specified.");
    }
    ...
    public GetMatchingCycles setLandQty(java.lang.Double landQty) {
